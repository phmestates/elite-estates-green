      ...
      <section className="py-24 md:py-32 bg-background relative">
        <div className="container mx-auto px-4 lg:px-8 max-w-6xl">
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            {/* Image Block (MOCK PHOTO PLACED HERE) */}
            <div className="lg:col-span-5 relative group">
              ...
              {/* High-end architectural mock photo */}
              <img
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-6 order-2 lg:order-1">
              ...
              <div className="mt-12 pt-10 border-t border-border/60 space-y-5">
                <a href="tel:+61290000000" className="flex items-center gap-5 hover:text-primary-dark transition-colors group">
                  ...
                  <span className="text-sm tracking-[0.1em] text-foreground/80 font-medium">Request a private consultation</span>
                </a>
                <a href="mailto:director@phmelite.com" className="flex items-center gap-5 hover:text-primary-dark transition-colors group">
                  <span className="w-10 h-10 rounded-full border border-gold/30 grid place-items-center group-hover:bg-gold transition-colors">
                    <Mail size={16} className="text-gold group-hover:text-primary-dark transition-colors" />
                  </span>
                  <span className="text-sm tracking-[0.1em] text-foreground/80 font-medium">director@phmelite.com</span>
                </a>
              </div>
            </div>
